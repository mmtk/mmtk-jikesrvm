...
1. Use a proper Rust toolchain. The minimal supported Rust version for MMTk-JikesRVM binding is 1.57.0. Make sure your Rust version is higher than this. We test MMTk-JikesRVM
